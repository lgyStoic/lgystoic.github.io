...
- analyze 环境：`GEMINI_MODEL=gemini-3.1-pro-preview`、`GEMINI_FALLBACK_MODEL=gemini-2.5-pro`、`GEMINI_MAX_OUTPUT_TOKENS=32768`、`GEMINI_TIMEOUT=600`、`GEMINI_PRIMARY_RETRIES=2`、job 超时 45 分钟。
